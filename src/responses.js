...
users['James Holden'] = {
  badge: {
    frame: 'un', name: 'James Holden', sex: 'm', age: '30', image: '/media/jamesFace.jpg',
  },
};
users['Naomi Nagata'] = {
  badge: {
    frame: 'opa', name: 'Naomi Nagata', sex: 'f', age: '29', image: '/media/naomiFace.jpg',
  },
};
users['Amos Burton'] = {
  badge: {
    frame: 'protogen', name: 'Amos Burton', sex: 'm', age: '35', image: '/media/amosFace.jpg',
  },
};
users['Alex Kamal'] = {
  badge: {
    frame: 'mcrn', name: 'Alex Kamal', sex: 'm', age: '32', image: '/media/alexFace.jpg',
  },
};
users['Josephus Miller'] = {
  badge: {
    frame: 'sh', name: 'Josephus Miller', sex: 'm', age: '41', image: '/media/millerFace.jpg',
  },
};
